...
class DictionaryManager(
    ...
    /**
     * バイト配列がUTF-8かEUC-JPか判定する
     * @return UTF-8 or EUC-JP or nullを返す
     */
     ...
     */
    suspend fun importDictionaryFromUri(uri: Uri, fileName: String): Result<Int> =
